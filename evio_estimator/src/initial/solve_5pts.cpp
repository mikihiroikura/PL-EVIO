...
bool MotionEstimator::solveRelativeHybrid(const vector<pair<Vector3d, Vector3d>> &corres, Matrix3d &Rotation, Vector3d &Translation)
{
    OptSolver sopt; 
    if (corres.size() >= 15)
    {
